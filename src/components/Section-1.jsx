...
function Main1() {
    return (
        <>
            ...
            <div className="flex flex-row  items-center  space-x-12  lg:justify-between px-6  section-scroll py-10">
                <div className="bg-white rounded-3xl flex flex-row flex-1 justify-between h-80 p-3 drop-shadow-lg space-x-2 ">
                    <div className=" w-52">
                ...
                <div className="bg-white rounded-3xl flex flex-row flex-1 h-80 p-3 drop-shadow-lg space-x-2">
