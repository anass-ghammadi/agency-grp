    ...
    return (
        <>
            <div className="flex flex-col min-h-max w-full h-screen mx-auto " style={{ background:"linear-gradient(251.55deg, rgba(119, 23, 194, 0.84) 13.25%, rgba(82, 22, 160, 0.891418) 45.83%, rgba(31, 21, 140, 0.92) 90.55%)"}}>
                ...
                <div className=" flex flex-row items-center justify-center mx-auto max-w-7xl h-full space-x-3 py-10 ">
                     <img className="w-24 sm:block hidden" src={Cube2}/>                   
                    <img  className="sm:block hidden"src={Ae}/>
                    <img className="sm:block hidden"src={Figma}/>
                    <img  className="sm:block hidden"src={Unity}/>
                    <img className="sm:block hidden" src={Ui}/>
