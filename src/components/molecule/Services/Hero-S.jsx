        ...
        <>
            <div className="flex flex-col   min-h-max w-full h-screen mx-auto " style={{ background:"linear-gradient(251.55deg, rgba(119, 23, 194, 0.84) 13.25%, rgba(82, 22, 160, 0.891418) 45.83%, rgba(31, 21, 140, 0.92) 90.55%)"}}>
                ...
                {/*waves*/}
                    ...
                    <div className=" flex flex-row-reverse items-center justify-center mx-auto max-w-7xl h-full space-x-3 py-10 md:flex-row-reverse md:mx-16 xl:mx-36 md:items-end md:justify-start">
                        <img className="w-24 md:w-32 sm:block hidden" src={Cube2}/>                   
                        <img  className="sm:block hidden w-14"src={Ae}/>
                        <img className="sm:block hidden w-14"src={Figma}/>
                        <img  className="sm:block hidden w-14"src={Unity}/>
                        <img className="sm:block hidden w-14" src={Ui}/>
                        <img  className="w-14" src={Flutter}/>
                        <img className="w-14" src={React}/>
                        <img  className="w-14"src={Vue}/>
                        <img  className="w-14 " src={Js}/>   
                    </div>
